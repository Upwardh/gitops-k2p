...
MULTIPART_UPLOAD_SIZE = (
    1024 * 1024 * 1024
)  # 1GB  # object sotrage에 file upload시 multipart 수행하는 최소 크기
MULTIPART_PART_SIZE = (
    1024 * 1024 * 200
)  # 200MB  # object sotrage의 multipart upload 시 part크기
...
class ZoneManager:
    ...
    def get_external_id(self):
        ...
        response = ku.request_api(
            func_name, "get", url, headers, self, params={"networkType": "UNTRUST"}
        )
...
class ComputeResource:
    ...
    def create_vm(
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, vm_name=name
        )
    ...
    def get_vm_info(self, vm_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, vm_id=vm_id
        )
    ...
    def delete_vm(self, vm_id, forced=False):
        ...
        if forced:
            ...
            response = ku.request_api(
                func_name, "delete", url, headers, self._zone_mgr, vm_id=vm_id
            )
    ...
    def start_vm(self, vm_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, vm_id=vm_id
        )
    ...
    def detach_volume(self, vm_id, volume_id):
        url = ku.get_request_url(
            "detach_volume", vm_id=vm_id, volume_id=volume_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def get_metric_info(self, params):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, params=params
        )
...
class StorageResource:
    ...
    def create_snapshot(self, name, volume_id, description=None):
        url = ku.get_request_url(
            "create_snapshot", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "create_snapshot",
    ...
    def list_snapshot_info(self):
        url = ku.get_request_url(
            "list_snapshot_info", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def delete_snapshot(self, snapshot_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, snapshot_id=snapshot_id
        )
    ...
    def get_snapshot_info(self, snapshot_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, snapshot_id=snapshot_id
        )
    ...
    def list_image_info(self):
        url = ku.get_request_url(
            "list_image_info", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def delete_image(self, image_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, image_id=image_id
        )
    ...
    def get_image_info(self, image_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, image_id=image_id
        )
    ...
    def create_volume(self, name, size, vol_type, snapshot_id=None):
        ...
        url = ku.get_request_url(
            "create_volume", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "create_volume",
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, volume_name=name
        )
    ...
    def get_volume_info(self, volume_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, volume_id=volume_id
        )
    ...
    def delete_volume(self, volume_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, volume_id=volume_id
        )
    ...
    def list_volume_info(self):
        url = ku.get_request_url(
            "list_volume_info", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def list_nas_info(self):
        url = ku.get_request_url(
            "list_nas_info", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def get_nas_info(self, nas_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, nas_id=nas_id
        )
    ...
    def create_nas(self, name, size, vol_type, network_id):
        ...
        url = ku.get_request_url(
            "create_nas", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "create_nas",
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, nas_name=name
        )
    ...
    def delete_nas(self, nas_id):
        url = ku.get_request_url(
            "delete_nas", project_id=self._project_id, zone=self._zone, share_id=nas_id
        )
        headers = self._zone_mgr.get_auth_header()

        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, nas_id=nas_id
        )
    ...
    def list_nas_network_info(self):
        url = ku.get_request_url(
            "list_nas_network_info", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def get_nas_network_info(self, network_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, network_id=network_id
        )
    ...
    def create_nas_network(self, name, subnet_id):
        url = ku.get_request_url(
            "create_nas_network", project_id=self._project_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "create_nas_network", nas_name=name, subnet_id=subnet_id
        )
    ...
    def delete_nas_network(self, network_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, network_id=network_id
        )
    ...
    def change_nas_size(self, nas_id, size):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, nas_id=nas_id
        )
    ...
    def set_nas_access(self, nas_id, level, cidr):
        ...
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "set_nas_access", access_level=level, access_cidr=cidr
        )
...
class NetworkResource:
    ...
    def delete_publicip(self, publicip_id):
        url = ku.get_request_url(
            "delete_publicip", publicip_id=publicip_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    # port forward 설정
    def set_portforward(
        self, privateip, publicip_id, private_port, public_port, protocol
    ):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "post", url, headers, self._zone_mgr, body=body
        )
    ...
    def unset_portforward(self, portforward_id):
        url = ku.get_request_url(
            "unset_portforward", portforward_id=portforward_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def get_portforward_info(self, portforward_id):
        ...
        response = ku.request_api(
            ...
            headers,
            self._zone_mgr,
            params={"portForwardingId": portforward_id},
        )
    ...
    def set_staticnat(self, privateip, publicip_id):  # subnet_id는 불필요하여 삭제
        ...
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "set_staticnat", privateip=privateip, publicip_id=publicip_id
        )
    ...
    def unset_staticnat(self, staticnat_id):
        url = ku.get_request_url(
            "unset_staticnat", staticnat_id=staticnat_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()
    ...
    def get_firewall_info(self, acl_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "get", url, headers, self._zone_mgr, params={"policyId": acl_id}
        )
    ...
    def set_firewall_net2net(
        ...
        if src_network_id == None:
            raise Exception(
                f"set_firewall_net2net() : src_net_id('{src_net_id}') not found!"
            )
        ...
        if dst_net_id == "external":
            ...
            if dst_network_id == None:
                raise Exception(
                    f"set_firewall_net2net() : dst_net_id('{dst_net_id}') not found!"
                )

        url = ku.get_request_url("set_firewall", zone=self._zone)
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "set_firewall_net2net",
            src_net_id=src_network_id,
            src_cidr=src_cidr,
            dst_net_id=dst_network_id,
            dst_cidr=dst_cidr,
            protocol=protocol,
            action=new_action,
            srcnat=srcnat,
        ...
        if start_port != None or end_port != None:
            ...
            if protocol == "TCP" or protocol == "UDP":
                raise Exception(
                    "set_firewall_net2net() : if protocol is 'TCP' or 'UDP', start_port and end_port are mandatory"
                )

        func_name = inspect.currentframe().f_code.co_name
        job_id = ku.request_net_api(
            func_name, "post", url, headers, self._zone_mgr, body=body
        )
    ...
    def set_firewall_portforward(self, portforward_id, src_cidr):
        ...
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "set_firewall_portforward",
            src_net_id=self._external_id,
            src_cidr=src_cidr,
        ...
        if pf_info:
            ...
            raise Exception(
                f"set_firewall_portforward() : portforward_id({portforward_id}) not found!"
            )
    ...
    def set_firewall_staticnat(
        self, staticnat_id, src_cidr, protocol, start_port=None, end_port=None
    ):
        interval = NET_JOB_INTERVAL
        count = 0
        ...
        headers = self._zone_mgr.get_auth_header()
        body = ku.get_request_body(
            "set_firewall_staticnat",
            src_net_id=self._external_id,
            src_cidr=src_cidr,
            staticnat_id=staticnat_id,
            protocol=protocol,
        )
        ...
        if start_port != None or end_port != None:
            ...
            if protocol == "TCP" or protocol == "UDP":
                raise Exception(
                    "set_firewall_staticnat() : if protocol is 'TCP' or 'UDP', start_port and end_port are mandatory"
                )
    ...
    def unset_firewall(self, acl_id):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response = ku.request_api(
            func_name, "delete", url, headers, self._zone_mgr, acl_id=acl_id
        )
    ...
    def create_subnet(
        ...
        body = ku.get_request_body(
            ...
            start_ip=startip,
            end_ip=endip,
            lb_start_ip=lbstartip,
            lb_end_ip=lbendip,
            bm_start_ip=bmstartip,
            bm_end_ip=bmendip,
            iscsi_start_ip=iscsistartip,
            iscsi_end_ip=iscsiendip,
        ...
        job_id = ku.request_net_api(
            func_name, "post", url, headers, self._zone_mgr, body=body, subnet_name=name
        )
    ...
    def delete_subnet(self, subnet_id):
        ...
        url = ku.get_request_url(
            "delete_subnet", network_id=network_id, zone=self._zone
        )
        headers = self._zone_mgr.get_auth_header()

        func_name = inspect.currentframe().f_code.co_name
        job_id = ku.request_net_api(
            func_name, "delete", url, headers, self._zone_mgr, subnet_id=subnet_id
        )
    ...
    def list_lb_info(self, lb_name=None, service_ip=None, lb_id=None):
        ...
        func_name = inspect.currentframe().f_code.co_name
        response, success = ku.request_lb_api(
            func_name, "get", url, headers, self._zone_mgr, "listloadbalancersresponse"
        )
    ...
    def create_lb(
        ...
        service_ip=None,
        ciphergroup_name=None,
        tlsv1=None,
        tlsv11=None,
        tlsv12=None,
    ):
        # 입력 paramter에 따라 필수 parameter가 있기 때문에 이를 확인
        ku.check_parameter_validation(
            lb_option,
            service_type,
            healthcheck_type,
            healthcheck_url,
        ...
        url = ku.get_lb_request_url(
            "create_lb",
            zone=self._zone,
            zoneid=self._zone_name,
            name=lb_name,
            loadbalanceroption=lb_option,
            serviceip=service_ip,
            serviceport=service_port,
            servicetype=service_type,
            healthchecktype=healthcheck_type,
            healthcheckurl=healthcheck_url,
            ciphergroupname=ciphergroup_name,
            tlsv1=tlsv1,
            tlsv11=tlsv11,
            tlsv12=tlsv12,
            networkid=subnet_id,
    ...
    def get_lb_usage(self, lb_name, start_date, end_date):
        ...
        response, success = ku.request_lb_api(
            ...
            headers,
            self._zone_mgr,
            "usageloadbalancerserviceresponse",
            lb_name=lb_name,
        )
    ...
    def add_lb_server(self, lb_id, vm_id, vm_ip, vm_port):
        ...
        response, success = ku.request_lb_api(
            ...
            headers,
            self._zone_mgr,
            "addloadbalancerwebserverresponse",
            lb_id=lb_id,
        )
    ...
    def list_lb_server(self, lb_id):
        url = ku.get_lb_request_url(
            "list_lb_server", zone=self._zone, loadbalancerid=lb_id
        )
        headers = self._zone_mgr.get_auth_header()
        ...
        response, success = ku.request_lb_api(
            ...
            headers,
            self._zone_mgr,
            "listloadbalancerwebserversresponse",
            lb_id=lb_id,
        )
    ...
    def remove_lb_server(self, service_id):
        url = ku.get_lb_request_url(
            "remove_lb_server", zone=self._zone, serviceid=service_id
        )
        headers = self._zone_mgr.get_auth_header()
        ...
        response, success = ku.request_lb_api(
            ...
            headers,
            self._zone_mgr,
            "removeloadbalancerwebserverresponse",
...
class ObjectStorage:
    ...
    def list_box(self):
        ...
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "GET", "", path
        )
        response = requests.get(url, headers=headers)
    ...
    def create_box(self, box_name):
        ...
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "PUT", "", path
        )
    ...
    def delete_box(self, box_name):
        ...
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "DELETE", "", path
        )
    ...
    def upload_box_file(self, box_name, file_path, key_name):
        try:
            ...
            if file_size >= MULTIPART_UPLOAD_SIZE:
                ...
                raise FileSizeError(
                    f'"{file_path}" size is too big, smaller than {max_size}GB'
                )
        except FileNotFoundError:
            raise Exception(f'"{file_path}" not exist')

        with open(file_path, "rb") as file:
            path = ku.get_object_path(
                "upload_box_file", box_name=box_name, key_name=key_name
            )
            url = ku.get_object_url(path)
            headers = ku.get_auth_header(
                self._access_key,
    ...
    def delete_box_file(self, box_name, key_name):
        path = ku.get_object_path(
            "delete_box_file", box_name=box_name, key_name=key_name
        )
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "DELETE", "", path
    ...
    def download_box_file(self, box_name, key_name):
        path = ku.get_object_path(
            "download_box_file", box_name=box_name, key_name=key_name
        )
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "GET", "", path
    ...
    def create_multipart_upload(self, box_name, key_name):
        path = ku.get_object_path(
            "create_multipart_upload", box_name=box_name, key_name=key_name
        )
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "POST", "", path
        )
    ...
    def upload_part(self, box_name, key_name, part_number, upload_id, data):
        ...
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "PUT", "application/octet-stream", path
        )
    ...
    def complete_multipart_upload(self, box_name, key_name, upload_id, parts):
        ...
        url = ku.get_object_url(path)
        headers = ku.get_auth_header(
            self._access_key, self._secret_key, "POST", "application/xml", path
        )
    ...
    def multipart_upload(self, box_name, file_path, key_name):
        try:
            ...
            if file_size < MULTIPART_UPLOAD_SIZE:
                max_size = MULTIPART_UPLOAD_SIZE / 1024 / 1024 / 1024
                raise FileSizeError(
                    f'"{file_path}" size is too small, bigger than {max_size}GB'
                )
        except FileNotFoundError:
            raise Exception(f'"{file_path}" not exist')
        ...
        with open(file_path, "rb") as f:
            ...
            while True:
                ...
                etag = self.upload_part(
                    box_name, key_name, part_number, upload_id, data
                )
        ...
        if self.complete_multipart_upload(
            box_name, key_name, upload_id, multipartupload
        ):
            return True
        return False
...
class VPC:
    ...
    def _get_vm_id(self, vm_name):
        return next(
            (item["vm_id"] for item in self.vm_list if item["vm_name"] == vm_name), None
        )

    def _get_vm_status(self, vm_id):
        return next(
            (item["status"] for item in self.vm_list if item["vm_id"] == vm_id), None
        )

    def _get_vm_privateip(self, vm_name):
        return next(
            (
                item["subnets"][0]["privateip"]
    ...
    def _get_lb_id(self, lb_name):
        return next(
            (item["lb_id"] for item in self.lb_list if item["lb_name"] == lb_name), None
        )

    def _get_lb_privateip(self, lb_name):
        return next(
            (item["service_ip"] for item in self.lb_list if item["lb_name"] == lb_name),
            None,
        )
            ...
            for j, vm_id in enumerate(chunk_ids):
                ...
                if status == None:
                    ...
                    if status == "ACTIVE":
                        ...
                        msg = (
                            f"""'{vm_name_list[j]}' VM 생성을 실패했습니다.({status})"""
                        )
                        ku.append_msg_list(msg_list, key_list[j], msg)
                ...
                if lb["name"] == old_lb["lb_name"]:
                    ...
                    if lb_update:
                        ...
                        for old_vm in old_server_list:
                            result_tmp = self.network.remove_lb_server(
                                old_vm["service_id"]
                            )
                            if result_tmp == False:
                                result = False
                        ...
                        for vm_info in vm_info_list:
                            result_tmp = self.network.add_lb_server(
                                old_lb["lb_id"],
                                vm_info["id"],
                                vm_info["privateip"],
                                lb["server_port"],
    ...
    def _create_lb(self, lb, new_ip_list):
        ...
        if service_ip_tmp.startswith("new_"):
            match_item = next(
                (item for item in new_ip_list if item["new"] == service_ip_tmp), None
            )
            if match_item == None:
                service_ip = None
            else:
        ...
        lb_inst = self.network.create_lb(
            lb["name"],
            lb["option"],
            lb["service_port"],
            lb["service_type"],
        ...
        if server_list != None:
            if server_port == None:
                raise Exception(
                    "if you want to add vm to lb, you have to define server_port"
                )
    ...
    def _set_firewall(self, fw):
        ...
        if fw["type"] == "net2net":
            ...
            if "start_port" in fw:
                start_port = (
                    str(fw["start_port"])
                    if isinstance(fw["start_port"], int)
                    else fw["start_port"]
                )
            if "end_port" in fw:
                end_port = (
                    str(fw["end_port"])
                    if isinstance(fw["end_port"], int)
                    else fw["end_port"]
                )

            return self.network.set_firewall_net2net(
                src_net_id,
                fw["src_cidr"],
                dst_net_id,
                fw["dst_cidr"],
            ...
            return self.network.set_firewall_staticnat(
                staticnat_id, fw["src_cidr"], fw["protocol"], start_port, end_port
            )
    ...
    def _create_ip(self, ip, key, new_ip_list, state, setting):
        ...
        if public_ip.startswith("new_"):
            if setting == "none":
                match_item = next(
                    (item for item in new_ip_list if item["new"] == public_ip), None
                )
                if match_item == None:
                    new_item = {}
        ...
        if ip["type"] == "port_forward":
            if setting == "none":
                ret = ip_inst.set_portforward(
                    private_ip, ip["private_port"], ip["public_port"], ip["protocol"]
                )
                time.sleep(1)
                if ret == None:
    ...
    def validate_create_res_from_dict(self, json_form, action="all"):
        ...
        if len(key_vm_list) > 0:
            result, msgs = ku.validate_vm_list(
                key_vm_list,
                self.flavor_list,
                self.subnet_list,
                self.image_list,
        ...
        if len(key_lb_list) > 0:
            result, msgs = ku.validate_lb_list(
                key_lb_list, self.subnet_list, self.vm_list, self.lb_list, action
            )
        ...
        if len(key_ip_list) > 0:
            result, msgs = ku.validate_ip_list(
                key_ip_list,
                self.vm_list,
                self.lb_list,
                self.ip_list,
        ...
        if len(key_fw_list) > 0:
            result, msgs = ku.validate_firewall_list(
                key_fw_list,
                self.subnet_list,
                self.pf_list,
                self.sn_list,
            ...
            if res_type == "publicip":
                ...
                if params["type"] == "static_nat":
                    ...
                    if private_ip == None:
                        ...
                        nat_info_list = self._get_portforward_info(
                            private_ip, "private"
                        )
                        for nat_info in nat_info_list:
                            if ku.str_to_int(params["private_port"]) == ku.str_to_int(
                                nat_info["private_port"]
                            ):
                                json_form["resources"][key]["nat_name"] = nat_info[
                                    "name"
                                ]
                                json_form["resources"][key]["state"] = "created"
                                break
    ...
    def validate_delete_res_from_dict(self, json_form, action="all"):
        ...
        if len(key_vm_list) > 0:
            result_tmp, msgs = ku.validate_delete_vm_list(
                key_vm_list, self.vm_list, action
            )
            msg_list = msg_list + msgs
            if result_tmp == False:
                result = False
        ...
        if len(key_lb_list) > 0:
            result_tmp, msgs = ku.validate_delete_lb_list(
                key_lb_list, self.lb_list, action
            )
            msg_list = msg_list + msgs
            if result_tmp == False:
                result = False
        ...
        if len(key_ip_list) > 0:
            result_tmp, msgs = ku.validate_delete_ip_list(
                key_ip_list, self.ip_list, self, action
            )
            msg_list = msg_list + msgs
            if result_tmp == False:
                result = False
        ...
        if len(key_fw_list) > 0:
            result_tmp, msgs = ku.validate_delete_firewall_list(
                key_fw_list, self.fw_list, action
            )
            msg_list = msg_list + msgs
            if result_tmp == False:
                result = False
    ...
    def _delete_ip_list(self, key_ip_list):
        ...
        for key_ip in key_ip_list:
            ...
            if ip["type"] == "static_nat":
                ...
                if res:
                    msg = (
                        f"""'{key_ip["nat_name"]}'port forward 설정이 삭제되었습니다."""
                    )
                    ku.append_msg_list(msg_list, key, msg)
                else:
                    if setting != "none":
    ...
    def validate_change_res_from_dict(self, json_form):
        ...
        if len(key_vm_list) > 0:
            result, msgs = ku.validate_change_vm_list(
                key_vm_list, self.flavor_list, self.vm_list
            )
        ...
        if len(key_lb_list) > 0:
            result, msgs = ku.validate_change_lb_list(
                key_lb_list, self.lb_list, self.vm_list
            )
    ...
    def validate_create_res_from_csv(
        self, vm_csv=None, lb_csv=None, ip_csv=None, fw_csv=None, action="all"
    ):
        json_form, result, msgs = self._csv_to_json_form(vm_csv, lb_csv, ip_csv, fw_csv)
    ...
    def validate_delete_res_from_csv(
        self, vm_csv=None, lb_csv=None, ip_csv=None, fw_csv=None, action="all"
    ):
        json_form, result, msgs = self._csv_to_json_form(vm_csv, lb_csv, ip_csv, fw_csv)
