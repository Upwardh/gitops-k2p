...
class PublicIPInstance:
    ...
    def set_portforward(self, privateip, private_port, public_port, protocol):
        return self._network.set_portforward(
            privateip, self._publicip_id, private_port, public_port, protocol
        )
...
class LBInstance:
    ...
    def update(self, lb_option=None, healthcheck_type=None, healthcheck_url=None):
        return self._network.update_lb(
            self._lb_id, lb_option, healthcheck_type, healthcheck_url
        )
